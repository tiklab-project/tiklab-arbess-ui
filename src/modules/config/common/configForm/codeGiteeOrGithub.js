...
import ConfigCodeGiteeOrGithubModal from "../../components/configForm/configCodeGiteeOrGithubModal";
...
const CodeGiteeOrGithub = props =>{
    ...
    return(
        <Fragment>
            ...
            <Form.Item label="仓库" name={name(codeType)} rules={[{required:true, message:"请选择仓库"}]}>
            ...
            <Form.Item label="分支" name={branch(codeType)}>
