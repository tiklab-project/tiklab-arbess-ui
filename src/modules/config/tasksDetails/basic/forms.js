...
import ProductNexus from "../product/productNexus";
import ProductSsh from "../product/productSsh";
...
const Forms = props => {
    ...
    const renderForms = dataItem =>{
        switch (dataItem.type){
            ...
            case 51:
                return <ProductNexus dataItem={dataItem}/>
            case 52:
                return <ProductSsh dataItem={dataItem}/>
        }
    }
