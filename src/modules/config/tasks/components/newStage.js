...
import SIcon from "../../config/components/sIcon";
        ...
        return(
            ...
            >
                <div className="newStages-job-sub">
                    <span className="newStages-job-icon"><SIcon type={item.type}/></span>
    ...
    return(
        <div className="guiView-main_group">
            ...
            }
           {
            ...
            <AddDrawer newStageDrawer={newStageDrawer} setNewStageDrawer={setNewStageDrawer}/>
        </div>
    )
}
