...
import PipelineInfo from "../../pipeline/pipeline/components/pipelineAddInfo";
import {Loading} from "../../common/loading/loading";
import "./pipelineBasic.scss";

const PipelineBasic = props =>{
...
export default inject("pipelineStore")(observer(PipelineBasic))
