...
export const artifact_maven = 'artifact_maven'; //Maven推送
export const artifact_docker = 'artifact_docker'; //Docker推送
export const artifact_nodejs = 'artifact_nodejs'; //Node.Js推送
export const pull_maven = 'pull_maven'; //Maven拉取
export const pull_nodejs = 'pull_nodejs'; //Node.Js拉取
export const pull_docker = 'pull_docker'; //Docker拉取
export const message = 'message'; //消息通知
export const script = 'script'; //执行脚本
export const post = 'post'; //后置处理
export const jdk = 'jdk'; //JDK
export const hadess = 'hadess'; //Hsadess
export const nexus = 'nexus'; //Nexus
