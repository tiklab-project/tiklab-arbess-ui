...
import {CONFIG_STORE,ConfigStore} from "./modules/config/tasks/tasks/store/configStore";
...
import {AUTHORIZE_STORE,AuthorizeStore} from "./modules/config/tasks/tasks/store/authorizeStore";
...
import {POSTPROCESS_STORE,PostprocessStore} from "./modules/config/postprocess/store/postprocessStore";
...
import {COND_STORE,CondStore} from "./modules/config/tasks/condition/store/conditionStore";
